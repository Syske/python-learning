...
finish_sheep_api = "https://cat-match.easygame2021.com/sheep/v1/game/game_over_ex?t=%s"
# 完成话题接口
...
map_info_ex = "https://cat-match.easygame2021.com/sheep/v1/game/map_info_ex?matchType=3"
    ...
    while True:
        ...
        try:
            ...
            if get_res.status_code == 200:
                ...
                avatar = "https://wework.qpic.cn/bizmail/JQMKaSUmibMlQibWtXEWZW0yJiaAF5nrzOiaia5wQQEszdpCaiag633z3pgw/0"
...
def finish_game_sheep(skin, rank_time):
    ...
    s.keep_alive = False
    finish_body={
        "MatchPlayInfo" : "",
       "rank_role" : 2,
       "rank_score" : 1,
       "rank_state" : 1,
       "rank_time" : rank_time,
    ...
    res = requests.post(finish_sheep_api  % (header_t), headers=request_header, json=finish_body, timeout=15, verify=False)
    # err_code为0则成功
    print(f"游戏完成结果：{res.json()}")
